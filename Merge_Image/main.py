...
def start():
    ...
    if len(txt_dest_path.get()) == 0:
        msgbox.showwarning("WARNING!!🦞: Please select the destination directory path")
        merge()
...
scrollbar.pack(side="right", fill="y") #fill --> decide to y-axis
...
opt_space = ["None", "Snall", "Medium", "Large"]
